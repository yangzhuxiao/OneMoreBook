...
- (void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data
{
    ...
    NSLog(@"%@", [result valueForKey:@"access_token"]);
    NSLog(@"%@", [result valueForKey:@"douban_user_name"]);
    NSLog(@"%@", [result valueForKey:@"douban_user_id"]);
    NSLog(@"%@", [result valueForKey:@"expires_in"]);
    NSLog(@"%@", [result valueForKey:@"refresh_token"]);
